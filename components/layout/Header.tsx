...
export const Header: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 z-50 w-full flex flex-col transition-all duration-300">
      <div className="bg-gradient-to-r from-indigo-600 to-blue-600 text-white text-[11px] sm:text-xs font-bold py-2 text-center px-4 relative z-[51]">
          <span className="opacity-95">🚧 Phiên bản thử nghiệm (Beta) - Dữ liệu và tính năng đang trong quá trình hoàn thiện.</span>
      </div>
      <div className="w-full bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 border-b border-border transition-colors duration-300">
