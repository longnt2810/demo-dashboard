...
import { ArrowLeft, RefreshCcw, ChevronLeft, ChevronRight, Calculator, PieChart, Download, Image as ImageIcon, FileSpreadsheet, Info, BookOpen, AlertTriangle, Wallet, PiggyBank, TrendingUp, Sparkles, Table as TableIcon } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-8">
        ...
        <div className="lg:col-span-8 space-y-6">
          ...
          <div className="flex p-1 bg-slate-100 dark:bg-slate-800 rounded-xl">
             ...
             >
                <PieChart className="h-4 w-4" /> Biểu đồ
             </button>
             <button 
             ...
             >
                <TableIcon className="h-4 w-4" /> Bảng chi tiết
             </button>
          </div>

          {/* 3. Conditional View: Chart OR Table */}
          {activeTab === 'chart' ? (
            <div className="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 h-full max-h-[450px] animate-fade-in">
              <div className="flex items-center justify-between mb-6">
                ...
                <button 
                  ...
                  className="group flex items-center gap-2 px-4 py-2 bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-200 border border-slate-200 dark:border-slate-700 hover:border-emerald-500 hover:text-emerald-600 rounded-full shadow-sm hover:shadow-md transition-all text-xs font-bold"
                >
                  <ImageIcon className="h-3.5 w-3.5" /> {t('pages.tools.compound.saveGraph')}
                </button>
              </div>
            ...
            <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden animate-fade-in">
                <div className="p-4 border-b border-slate-100 dark:border-slate-700 bg-slate-50 dark:bg-slate-900/50 flex items-center justify-between">
                  <h3 className="font-semibold text-slate-900 dark:text-white flex items-center gap-2">
                      ...
                      {t('pages.simulator.breakdown')}
                  </h3>
                  <button 
                    onClick={handleExportExcel}
                    className="group flex items-center gap-2 px-4 py-2 bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-200 border border-slate-200 dark:border-slate-700 hover:border-emerald-500 hover:text-emerald-600 rounded-full shadow-sm hover:shadow-md transition-all text-xs font-bold"
                  >
                    <FileSpreadsheet className="h-3.5 w-3.5" /> {t('pages.tools.compound.exportExcel')}
                  </button>
                </div>
